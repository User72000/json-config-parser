/** @license black-box-editor v1.0.4
 *
 * This source code is licensed under the 83incs license found in the
...
function (_Component) {
  ...
  function JSONInput(props) {
    ...
    _this.randomString = _this.randomString.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
  ...
  (0, _createClass2.default)(JSONInput, [{
    ...
    value: function componentDidMount() {
      ...
      document.getElementById(contentID).addEventListener('paste', function (e) {
        e.preventDefault(); //customized

        var text = e.clipboardData.getData('text/plain');
        var minifiedJson = JSON.stringify(JSON.parse(text));
    ...
    value: function showPlaceholder() {
      ...
      if ((0, _typeof2.default)(placeholder) !== 'object') return;
