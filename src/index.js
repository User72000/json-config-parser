...
class JSONInput extends Component {
    constructor(props) {
        ...
        if (!this.props.locale) {
            console.warn("[json-parser - Deprecation Warning] You did not provide a 'locale' prop for your JSON input - This will be required in a future version. English has been set as a default.");
        }
    }

    updateInternalProps() {
        console.log("updateInternalProps", this.props)
    ...
    update(cursorOffset = 0, updateCursorPosition = true) {
        const
            ...
            data =this.state.clear ? "" : this.tokenize(container);
        console.log("update--container==", container, "    data====", data)
